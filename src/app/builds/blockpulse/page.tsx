...
export default function BlockPulseBuildPage() {
  return (
    <main className="min-h-screen bg-canvas text-ink pt-32 md:pt-40 pb-24 selection:bg-accent selection:text-canvas">
      ...
      {/* 2. APP SHOWCASE (CUSTOM COMPOSITION) */}
      <div className="w-full flex flex-col gap-8 md:gap-16 px-4 md:px-8 lg:px-12 mx-auto max-w-[1600px]">
        ...
        >
          <ImagePlaceholder label="AUTONOMOUS PIPELINE & DATA INFRASTRUCTURE" aspect="aspect-[16/9] md:aspect-[21/9]" />
        </motion.div>

        {/* 3-column mobile app showcase */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 max-w-6xl mx-auto w-full">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
          ...
          >
            <ImagePlaceholder label="APP HOME" aspect="aspect-[9/19]" className="bg-canvas-alt rounded-[2rem]" />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <ImagePlaceholder label="SIGNAL FILTERING" aspect="aspect-[9/19]" className="bg-canvas-alt rounded-[2rem]" />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <ImagePlaceholder label="ARTICLE VIEW" aspect="aspect-[9/19]" className="bg-canvas-alt rounded-[2rem]" />
          </motion.div>
        </div>
